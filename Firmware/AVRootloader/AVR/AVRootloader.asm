...
.equ	RX_PORT			= PORTA		; Receive port and pin
.equ	RX			= PA4
.equ	TX_PORT			= PORTA		; Transmit port and pin
.equ	TX			= PA4
...
.set	BootCodeSize		= 600		; set to 0, compile and set to value in [.cseg] Used, compile again
...
.if UseCrypt && (UseSRAM || !UseCryptFLASH || !UseCryptE2)
...
BootSign:	.db		"BOOTLOADER"											; iff you change it then change sign in AVRootloader.ini
